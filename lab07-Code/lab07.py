...
def store_digits(n):
    ...
    while nn >= 10:
        nn //= 10
        base *= 10
    return Link(n // base, store_digits(n % base))
...
def make_to_string(front, mid, back, empty_repr):
    ...
    def to_string_recursive(ll):
        ...
        return front + str(ll.first) + mid + to_string_recursive(ll.rest) + back
...
def cumulative_mul(t):
    ...
    """
    "*** YOUR CODE HERE ***"
    # # Wrong!! not a non-return function!!
    # if t.is_leaf:
    #     return t.label
    #
    # for b in t.branches:
...
def prune_small(t, n):
    ...
    if nbranches > n:
        ...
        # pop branches[n], branches[n+1], ..., branches[len-1].
        for i in range(nbranches - 1, n - 1, -1):
            t.branches.pop(i)
